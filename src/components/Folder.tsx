...
const Folder = ({ folderName,  videosCount}: FolderProps) => {
  return (
    <div className="px-4 py-2 border border-border bg-card flex rounded-sm justify-between items-center w-[200px] relative overflow-hidden hover:cursor-pointer hover:shadow-2xl hover:scale-[1.02] transition-all">
      <div>

export default function Loader({ color = "#fff", size = 32, className = "" }) {
  return (
    <div role="status" className={`flex items-center justify-center ${className}`}>
      <svg
        aria-hidden="true"
        className={`inline w-${size / 4} h-${size / 4} text-gray-200 animate-spin dark:text-gray-600`}
        viewBox="0 0 100 101"
        fill="none"
      ...
      >
        <path
          d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 
             0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 
        ...
        <path
          d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 
             ...
             75.2124 7.41289C69.5422 4.10298 63.2666 1.94025 
             56.7698 1.05126C51.7666 0.367006 46.6976 
             ...
             10.0496C60.8642 10.7766 65.9922 
             12.5457 70.6331 15.2552C75.2739 
             17.9648 79.3342 21.5619 82.5849 
             25.8416C84.9175 28.8217 86.7997 
             32.2913 88.1811 35.8758C89.0833 

    ...
    >
      <g fill="none">
        <path
          ...
          fill="url(#e2hk6h0rjvn-1752500502766-7626048_bell_existing_0_14lff8flw)"
          data-glass="origin"
          mask="url(#e2hk6h0rjvn-1752500502766-7626048_bell_mask_fyq300pns)"
        ></path>
        <path
          d="M15.5 19.5C15.5 21.433 13.933 23 12 23C10.067 23 8.5 21.433 8.5 19.5C8.5 17.567 10.067 16 12 16C13.933 16 15.5 17.567 15.5 19.5Z"
          fill="url(#e2hk6h0rjvn-1752500502766-7626048_bell_existing_0_14lff8flw)"
          data-glass="clone"
          filter="url(#e2hk6h0rjvn-1752500502766-7626048_bell_filter_44txncefw)"
          clip-path="url(#e2hk6h0rjvn-1752500502766-7626048_bell_clipPath_wi1z96ji7)"
        ></path>
        <path
          ...
          fill="url(#e2hk6h0rjvn-1752500502766-7626048_bell_existing_1_cf31vy2bg)"
          data-glass="blur"
        ></path>
        <path
          ...
          fill="url(#e2hk6h0rjvn-1752500502766-7626048_bell_existing_2_82e85sl3p)"
        ></path>
        <defs>
          <linearGradient
            id="e2hk6h0rjvn-1752500502766-7626048_bell_existing_0_14lff8flw"
            x1="12"
            y1="16"
            x2="12"
            y2="23"
          ...
          <linearGradient
            id="e2hk6h0rjvn-1752500502766-7626048_bell_existing_1_cf31vy2bg"
            x1="12"
            y1="1"
            x2="12"
            y2="19"
          ...
          <linearGradient
            id="e2hk6h0rjvn-1752500502766-7626048_bell_existing_2_82e85sl3p"
            x1="12"
            y1="1"
            x2="12"
            y2="11.424"
          ...
          <filter
            id="e2hk6h0rjvn-1752500502766-7626048_bell_filter_44txncefw"
            x="-100%"
            y="-100%"
            width="400%"
            height="400%"
          ...
          <clipPath id="e2hk6h0rjvn-1752500502766-7626048_bell_clipPath_wi1z96ji7">
            <path
              d="M4 9C4 4.58172 7.58172 1 12 1C16.4183 1 20 4.58172 20 9V12.1246C20 12.7003 20.134 13.2681 20.3915 13.783L20.6845 14.3689C21.4512 15.9024 21.8345 16.6691 21.7425 17.2923C21.662 17.8365 21.361 18.3236 20.9102 18.6389C20.3939 19 19.5367 19 17.8223 19H6.17771C4.46327 19 3.60606 19 3.08979 18.6389C2.63898 18.3236 2.33795 17.8365 2.25755 17.2923C2.16546 16.6691 2.54882 15.9024 3.31554 14.3689L3.60851 13.783C3.86597 13.2681 4 12.7003 4 12.1246V9Z"
              fill="url(#e2hk6h0rjvn-1752500502766-7626048_bell_existing_1_cf31vy2bg)"
            ></path>
          </clipPath>
          <mask id="e2hk6h0rjvn-1752500502766-7626048_bell_mask_fyq300pns">
